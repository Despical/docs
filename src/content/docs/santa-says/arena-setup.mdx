...
See the [`signs.yml` configuration guide](/santa-says/configuration/signs) to customize its layout, state labels, and messages.
...
| `FIREWORK_ROCKET` | Register          | Save and activate the arena.              |
