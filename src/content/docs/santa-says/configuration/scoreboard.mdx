...
waiting:
  ...
  lines:
    ...
    - "<white>Need <green>%players_needed% <white>more player%s%"
    - ""
...
in-game:
  title: "<yellow><bold>SANTA SAYS"
  lines:
    - "<gray>1. %player_1%: <green>%player_1_score%"
    - "<gray>2. %player_2%: <green>%player_2_score%"
    - "<gray>3. %player_3%: <green>%player_3_score%"
    - "%if_not_in_top3%<white>. . ."
    - "%if_not_in_top3%<gray>%player%: <green>%score%"
    - ""
    - "<white>Round: <green>%round%/15"
    - ""
    - "<yellow>www.greenmc.io"
  ```
