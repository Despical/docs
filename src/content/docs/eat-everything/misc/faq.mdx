...
The plugin is compiled using **Java Development Kit (JDK) 25**. Therefore, **Java 25 or newer** is strictly required to run **Eat Everything**.
...
Use Paper 1.21.11 or a compatible fork. The project is compiled against Paper 1.21.11 APIs and depends on the modern item data component system.
