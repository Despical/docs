...
## Built-in Framework Error Messages
...
<Aside type="caution">
    Setting a custom message formatter replaces the default MiniMessage string parser. Use it when your plugin messages are primarily legacy strings.
</Aside>
