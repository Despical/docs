...
| :--- | :--- | :--- |
| `config.yml` | Core settings, particle effects, sounds, and global commands. | Current Page [(Below)](/docs/easter-eggs/configuration#global-settings-configyml) |
| `messages.yml` | All chat messages, GUI titles, and lore. | Current Page [(Below)](/docs/easter-eggs/configuration#messaging-and-localization-messagesyml) |
| `mysql.yml` | **Database connection settings.** | [Database Configuration](/docs/easter-eggs/database) |
...
These sections in `config.yml` control visual and auditory feedback. Refer to the [FAQ page](/docs/easter-eggs/faq) for lists of available particle and sound names.
