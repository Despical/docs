...
| `action-bar-disabled`| `false`| If `true`, hides the action bar message upon collection. |
| `remove-on-collect`| | **Sub-section:** Handles block removal logic. |
| └ `enabled` | `false` | Removes the block physically after collection if true. |
