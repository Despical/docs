...
### Reload
Reloads all configuration files (`config.yml`, `messages.yml`, etc.) and refreshes the Easter Egg data.
Use this to apply changes made to the files without restarting the server.
