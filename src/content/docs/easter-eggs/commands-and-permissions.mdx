...
### Menu
Opens an interactive GUI. This interface allows you to visually browse eggs, teleport to them,
remove them, get a copy, or remove all.
...
The item in your hand must be a valid Easter Egg. The new item will retain the properties of an egg but will visually change to the ID you specify.
...
<Aside type="caution">
    This command will delete the blocks from the world and remove their locations from the database.
</Aside>
