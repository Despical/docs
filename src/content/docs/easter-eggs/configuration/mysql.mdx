...
By default, **Easter Eggs** stores player data using local files, but it can be configured to use a MySQL database instead.
...
| `<database_name>` | **Database Name:** The specific name of your database. You **must** replace this with your actual database name (e.g., `easter_eggs_db`). |
