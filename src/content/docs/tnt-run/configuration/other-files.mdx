...
### arenas.yml
This is the most critical system file. It contains every arena's location data, map name, readiness state, player limits, sign location, scoreboard and bossbar toggles, potion effects, and record data.
