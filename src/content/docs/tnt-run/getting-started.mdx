...
<Steps>
    1. Download the latest **TNT Run** build from [SpigotMC](https://www.spigotmc.org/resources/tnt-run.83196/), [BuiltByBit](https://builtbybit.com/resources/tnt-run.116706/) or [Modrinth](https://modrinth.com/plugin/tnt-run-minigame).
