...
<Steps>
    1. Download the latest **TNT Run** build from [SpigotMC](https://www.spigotmc.org/resources/tnt-run.83196/) or [BuiltByBit](https://builtbybit.com/resources/tnt-run.116706/).
