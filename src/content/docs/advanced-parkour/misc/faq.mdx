...
The plugin is compiled using **Java Development Kit (JDK) 25**. Therefore, **Java 25 or newer** is strictly required to run **Advanced Parkour**.
...
* **Supported Versions:** Full and native support for **1.20 - 26.2 and all newer versions**.
