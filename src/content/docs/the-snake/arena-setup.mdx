...
<Steps>
    ...
    2. Move to the camera position, face the board, and use **Set Start Location**.
    3. Move to the safe return point and use **Set End Location**.
    4. Hold **Board Setter** and click the first board corner.
    5. Click the opposite corner on the same 2D plane.
    6. Open **Options** and adjust the arena settings.
    7. Use **Save** to serialize all changed locations and options.
    8. Use **Stop Editing** to restore the inventory and leave editor mode.
</Steps>
